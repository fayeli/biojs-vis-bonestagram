...
biojsvisbonestagram.visualiseDICOM = function (){
  ...
  biojsvisbonestagram.setBonesImg({img:dicomImg, coords:pointsSelectorCoords});
  visCore.startFace();
}
